...
import com.example.tests.model.YouTubeItem;
...
public class YouTubeApiService {
  ...
  private static final String YOUTUBE_APIKEY_ENV      = "AIzaSyDHLTxNDLdTMCdsgwJbbRHPyEtmmW4DElU";
  		  ...
  		  try {
  	         ...
  	         if (youtube != null) {
                ...
                if ( apiKey == null ) {
				 ...
				 System.out.println("YouTube API not initialized correctly!");
  	         }
